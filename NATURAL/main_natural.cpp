...
natural operator-(const natural& a, const natural& b)
{
  ...
  if((a_t-b_t)<0) {
    ...
    cout << "Error, el resultado de la resta no es un número natural" << endl;
    return 0;
...
int main() {
  ...
  natural A, X;//constructor por defecto
  natural B(5);//constructor de asignación
  natural C(5+B);//constructor de copia
